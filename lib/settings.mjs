...
/**
 * Opt-in prompt capture: whether the wrapper should record prompt text +
 * Claude session id into the timing log. Off unless explicitly enabled.
 */
export function getCapturePrompts() {
  return loadSettings().capturePrompts === true;
}

export function setCapturePrompts(enabled) {
  const settings = loadSettings();
  settings.capturePrompts = !!enabled;
